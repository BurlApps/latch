...
public class Latch: LTTouchIDDelegate, LTPasscodeDelegate {
    ...
    public var passcodeInstruction: String = NSLocalizedString("Enter Passcode", bundle: LTBundle, comment: "")
  public var changePasscodeInstruction: String = NSLocalizedString("Enter your old passcode", bundle: LTBundle, comment: "")
